...
// use vite-plugin-monkey@0.2.14 at 2022-07-17T06:56:01.822Z
...
(function() {
  ...
  class TextInputCell {
    constructor(val, placeholder) {
      __publicField(this, "elem");
      this.elem = $(`<input class="form-control input-sm" type="text"></input>`).attr("placeholder", placeholder === void 0 ? "" : placeholder).val(val === void 0 ? "" : val);
    }
    get value() {
  ...
  class QuickAnswer {
    constructor() {
      __publicField(this, "name", "Quick Answer");
      __publicField(this, "settingTab");
      __publicField(this, "view");
      __publicField(this, "_enabled", false);
      __publicField(this, "settingTable");
